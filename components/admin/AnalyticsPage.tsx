...
const AnalyticsPage: React.FC<Props> = ({ user }) => {
  ...
  const calculateAnalytics = () => {
    ...
    // 4. Attendance Trends (Flat 0 if no data, otherwise calculate based on day)
  ...
  // 7. Heatmap Data (Derived from Booking Times)
            ...
            <div className="flex justify-between">
                <div>
                    ...
                    <h3 className="text-2xl font-bold text-slate-800 dark:text-white mt-1">
                        {Math.round(attendanceTrendData.reduce((a: any, b: any) => a + b.percentage, 0) / 5)}%
                    </h3>
