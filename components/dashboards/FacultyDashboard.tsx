...
const FacultyDashboard: React.FC<Props> = ({ user }) => {
  ...
  const refreshData = async () => {
      ...
      setPendingCount(getPendingUsersByRole(UserRole.STUDENT, user.department, user.managedSemesters).length);
                               ...
                               <div className="flex justify-between items-start">
                                   <div className="flex gap-4 items-center">
                                       <div className={`w-10 h-10 rounded-full flex items-center justify-center text-lg ${
                                           act.activityType === 'checkin' ? 'bg-green-100 dark:bg-green-900/30 text-green-600' :
                                           ...
                                           <i className={`fa-solid ${
                                               act.activityType === 'checkin' ? 'fa-arrow-right-to-bracket' :
                                   ...
                                   <div className="text-right">
                                       ...
                                       {act.status && (
                                           <span className={`text-[10px] font-bold uppercase px-2 py-0.5 rounded-full ${
                                               act.status === 'present' ? 'bg-green-100 dark:bg-green-900/30 text-green-700' :
