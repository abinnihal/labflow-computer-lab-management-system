  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400">View your academic information and manage account security.</p>
      </div>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 flex flex-col items-center text-center transition-colors">
            ...
            <p className="text-sm text-slate-500 dark:text-slate-400 mb-4">{user.facultyId || 'FAC-ID-NOT-ASSIGNED'}</p>

            <div className="w-full grid grid-cols-2 gap-2 text-center text-xs border-t border-slate-100 dark:border-slate-700 pt-4">
              <div>
                <p className="font-bold text-slate-700 dark:text-slate-300">{user.department || 'General'}</p>
                <p className="text-slate-400 dark:text-slate-500">Department</p>
              </div>
              <div>
                <p className="font-bold text-slate-700 dark:text-slate-300">{user.programType || 'UG'}</p>
                <p className="text-slate-400 dark:text-slate-500">Level</p>
              </div>
            </div>
          </div>

          <div className="bg-gradient-to-br from-purple-600 to-indigo-700 dark:from-purple-700 dark:to-indigo-800 rounded-xl p-6 text-white shadow-lg">
            <div className="flex items-center gap-3 mb-2">
              <i className="fa-solid fa-shield-halved text-2xl"></i>
              <h3 className="font-bold">Faculty Status</h3>
            </div>
            <p className="text-purple-100 text-sm mb-4">Your account is active and verified by the institute.</p>
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <input type="text" value={user.department || 'Computer Science'} disabled className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-500 dark:text-slate-400 cursor-not-allowed" />
                </div>
                <div>
