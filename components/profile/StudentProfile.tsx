  ...
  return (
    <div className="max-w-5xl mx-auto space-y-6">
      ...
      <div>
        ...
        <p className="text-slate-500 dark:text-slate-400">Manage your personal information and account security.</p>
      </div>
        ...
        <div className="space-y-6">
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 flex flex-col items-center text-center transition-colors">
             ...
             <div className="w-full grid grid-cols-2 gap-2 text-center text-xs border-t border-slate-100 dark:border-slate-700 pt-4">
                <div>
                   <p className="font-bold text-slate-700 dark:text-slate-300">{user.course}</p>
                   <p className="text-slate-400 dark:text-slate-500">Course</p>
                </div>
                <div>
                   <p className="font-bold text-slate-700 dark:text-slate-300">{profileData.semester}</p>
          ...
          <div className="bg-white dark:bg-slate-800 rounded-xl shadow-sm border border-slate-200 dark:border-slate-700 p-6 transition-colors">
             ...
             <form onSubmit={handleUpdateProfile} className="space-y-4">
                ...
                <div>
                   ...
                   <p className="text-[10px] text-slate-400 dark:text-slate-500 mt-1">Email cannot be changed. Contact admin for corrections.</p>
                </div>

                <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                   <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Program Type</label>
                      <input type="text" value={user.programType || 'N/A'} disabled className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-500 dark:text-slate-400 cursor-not-allowed" />
                   </div>
                   <div>
                      <label className="block text-xs font-bold text-slate-500 dark:text-slate-400 uppercase mb-1">Class / Course</label>
                      <input type="text" value={user.course} disabled className="w-full px-3 py-2 bg-slate-50 dark:bg-slate-700 border border-slate-200 dark:border-slate-600 rounded-lg text-slate-500 dark:text-slate-400 cursor-not-allowed" />
                   </div>
                   <div>
                      ...
                      >
                         {[1,2,3,4,5,6,7,8].map(i => (
                           <option key={i} value={`${i}${i===1?'st':i===2?'nd':i===3?'rd':'th'}`}>{i}{i===1?'st':i===2?'nd':i===3?'rd':'th'} Semester</option>
                         ))}
                      </select>
                   </div>
                </div>
